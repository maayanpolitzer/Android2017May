...
public class Validation {
    ...
    public static boolean isPasswordEquals(EditText conPasswordET, String password) {
        String conPassword = conPasswordET.getText().toString().trim();
        boolean theSame = conPassword.equals(password);
        if(!theSame){
            conPasswordET.setError("Must be like password");
        }
        return theSame;
    }
}
